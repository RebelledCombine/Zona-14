...
ent-Z14ClothingHeadHatHoodJacketStalkerWhite = hood
    .desc = Hoods, helmets and the like.
    .suffix = Z14

ent-Z14ClothingJacketSci = jacket
    .desc = Hoods, helmets and the like.
    .suffix = Z14

ent-Z14ClothingJaketGeneral = General's Uniform
    .desc = One, two, calculate!
    .suffix = Z14

ent-Z14ClothingJaketGray = pea coat
    .desc = double-breasted coat with warm lining with turn-down collar
    .suffix = Z14

ent-Z14ClothingJaketRealHuman = White Jacket
    .desc = White jacket with a scorpion pattern on the back. In it, you will feel like a real person.
    .suffix = Z14

ent-Z14ClothingOuterCoatIvyAnomalist = anomalist ivy jacket
    .desc = anomalist jacket
    .suffix = Z14

ent-Z14ClothingOuterJacketBandit = bandit jacket
...
ent-Z14ClothingOuterJacketCN = Clear Sky Jacket
...
ent-Z14ClothingOuterJacketDeserter = Renegade Jacket
...
ent-Z14ClothingOuterJacketDolg = Debt Jacket
...
ent-Z14ClothingOuterJacketMonolith = Monolith Jacket
...
ent-Z14ClothingOuterJacketStalker = Stalker Jacket
...
ent-Z14ClothingOuterJacketStalkerWhite = White Stalker Jacket
    .desc = Normal clothing of a novice stalker. It does not save the wearer from either a bullet or anomalies, but it is comfortable to wear.
    .suffix = Z14

ent-Z14STClothingHeadHatHoodBase = hood
    .desc = Hoods, helmets and the like.
    .suffix = Z14

ent-Z14STClothingOuterJacketBase = Basic Jacket
