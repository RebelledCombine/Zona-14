# Zona14: backpack name corrections ported from Roland410/omgbalance
...
ent-ClothingBackpackTacticOliveStalker = Olive Tactical Backpack
    .desc = It's never colorful or bright, as one of the jobs of tactical backpacks is to disguise themselves as environments, whether it's mountains, forests, or deserts.
ent-STClothingBackpackDuffelHikingNeutral = Small Hiking Backpack
    .desc = Roomy backpack, usually taken on hikes, but in the zone just right!
ent-ClothingBackpackMercStalker = Hiking Backpack
    .desc = Roomy backpack, usually taken on hikes, but in the zone just right!
    .suffix = ST
ent-ClothingBackpackDuffelCommonStalker = Old Army Backpack
    .desc = Roomy backpack, usually taken on hikes, but in the zone just right!
    .suffix = ST
ent-ClothingBackpackDuffelMilitaryBlue = Blue Hunting Backpack
    .desc = A great backpack with pouches for tactical needs.
    .suffix = ST
ent-ClothingBackpackDuffelMilitaryOlive = Dark Green Hunting Backpack
    .desc = A great backpack with extra compartments.
    .suffix = ST
ent-ClothingBackpackDuffelBlackMilitaryTacticStalker = Black Hunting Backpack
    .desc = A great backpack with extra compartments.
    .suffix = ST
...
ent-STClothingBackpackT4 = Tag* thing DO NOT SPAWN
    .desc = Tag* thing DO NOT SPAWN
