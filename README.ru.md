...
Весь новый код Zona-14 изолирован в папках `_Zona14/`. Подробнее о правилах контрибьюта — в [CONTRIBUTING.ru.md](CONTRIBUTING.ru.md) (или в полной [англоязычной версии](CONTRIBUTING.md)).
...
[Zona-14 Discord](https://discord.gg/NMWhRspejA) | [Issues (баги и фидбек)](https://github.com/Zona-14/Zona-14/issues) | [Stalker14 Discord](https://discord.gg/GXzurVkWYX) | [SS14 Вики](https://wiki.station14.ru) | [Steam](https://store.steampowered.com/app/1255460/Space_Station_14/) | [Клиент без Steam](https://spacestation14.io/about/nightlies/) | [Репозиторий Zona-14](https://github.com/Zona-14/Zona-14) | [Апстрим stalker14-project](https://github.com/stalker14-project/stalker14)
...
Коротко: весь новый код Zona-14 кладётся в папки `_Zona14/`, правки в файлах вне `_Zona14/` помечаются комментарием `// Zona14:`, у каждого `meta.json` должны быть заполнены поля `license` и `copyright`. Локальная проверка перед пушем: `bash Tools/_Zona14/check-conventions.sh origin/master HEAD`.

Обсуждение разработки, новости, анонсы, плейтесты, загрузка больших видео для PR — [Zona-14 Discord](https://discord.gg/NMWhRspejA). Баг-репорты, обратная связь и фича-реквесты — [Issues этого репозитория](https://github.com/Zona-14/Zona-14/issues) или [Zona-14 Discord](https://discord.gg/NMWhRspejA). Вопросы по апстриму `stalker14-project` — их [Discord](https://discord.gg/GXzurVkWYX).
...
- **Код команды Zona-14** (всё под `_Zona14/`) — под [MIT](LICENSE.TXT) © 2024-2026 Zona-14 Team. Открывая PR с файлами в `_Zona14/`, вы соглашаетесь на лицензирование вашего вклада по условиям Zona-14 MIT.
