...
using Robust.Shared.Containers; // stalker-en
...
public sealed class ParticleOnEventSystem : EntitySystem
{
    ...
    [Dependency] private readonly SharedContainerSystem _containerSystem = default!; // stalker-en
    ...
    private void OnGunShot(Entity<ParticleOnGunShotComponent> ent, ref AmmoShotEvent args) // stalker-en-start
    {
    ...
    private void Spawn(ParticleOnEventBase comp, EntityUid target, Angle? angle = null) // stalker-en
    {
        ...
        if (angle != null) // stalker-en-start
            ...
            _particles.CreateParticle(comp.Effect, target, comp.ColorOverride); // stalker-en-end
    }
}
