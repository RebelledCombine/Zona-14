using Content.Server._Stalker.Storage; // Stalker-using
...
public sealed partial class AdminVerbSystem
{
    ...
    [Dependency] private readonly StalkerStorageSystem _stalkerStorageSystem = default!; // Stalker-Dependency
    ...
    public void HomingLaunchSequence(EntityUid target, EntProtoId proto, float distance, float speed)
    {
        ...
        chasingComp.NextChangeVectorTime = TimeSpan.MaxValue / 2; // stalker-changes: MaxValue/2 to prevent overflow in [AutoPausedField] handler
